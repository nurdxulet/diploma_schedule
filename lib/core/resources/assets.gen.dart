...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/enabled_icon.svg
  SvgGenImage get enabledIcon =>
      const SvgGenImage('assets/icons/enabled_icon.svg');

  /// File path: assets/icons/exclamation_icon.svg
  SvgGenImage get exclamationIcon =>
      const SvgGenImage('assets/icons/exclamation_icon.svg');
  ...
  SvgGenImage get icSortFromBottom =>
      const SvgGenImage('assets/icons/ic_sort_from_bottom.svg');

  /// File path: assets/icons/ic_sort_from_top.svg
  SvgGenImage get icSortFromTop =>
      const SvgGenImage('assets/icons/ic_sort_from_top.svg');
  ...
  /// File path: assets/icons/irek_bg.svg
  ...
  /// File path: assets/icons/pair_work.svg
  SvgGenImage get pairWork => const SvgGenImage('assets/icons/pair_work.svg');

  /// File path: assets/icons/paper_clip.svg
  SvgGenImage get paperClip => const SvgGenImage('assets/icons/paper_clip.svg');

  /// File path: assets/icons/pdf_border.svg
  ...
  SvgGenImage get subjects => const SvgGenImage('assets/icons/subjects.svg');

  /// File path: assets/icons/tail_l.svg
  SvgGenImage get tailL => const SvgGenImage('assets/icons/tail_l.svg');

  /// File path: assets/icons/tail_r.svg
  SvgGenImage get tailR => const SvgGenImage('assets/icons/tail_r.svg');
  ...
  List<SvgGenImage> get values => [
        ...
        rightBackground,
        rightForeground,
        rightForegroundLonger,
        schedule,
        subjects,
        tailL,
        tailR,
        tasks,
        teenyiconsCalendarSolid,
        test,
        triangleShadow
      ];
}
